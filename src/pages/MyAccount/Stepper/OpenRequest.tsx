...
const OpenRequest = () => {
  ...
  //     //   Swal.fire({
  //     //     icon: "success",
  //     //     title: "Your issue has been submitted as a new issue",
  //     //     showConfirmButton: true,
  //     //     confirmButtonText: "Ok",
  //     //     customClass: {
  //     //       container: "swal-container",
  ...
  //     //   Swal.fire({
  //     //     icon: "success",
  //     //     title: "Your issue has been submitted and is now open",
  //     //     showConfirmButton: true,
  //     //     confirmButtonText: "Ok",
  //     //     customClass: {
  //     //       container: "swal-container",
  ...
  //     //   Swal.fire({
  //     //     icon: "success",
  //     //     title: "Your issue has been submitted and is now resolved",
  //     //     showConfirmButton: true,
  //     //     confirmButtonText: "Ok",
  //     //     customClass: {
  //     //       container: "swal-container",
    ...
    <div>
      ...
      <Box sx={{ width: '100%' }}>
        <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
          ...
          <Grid item xs={12} sm={8} md={8} lg={8} xl={12}>
            <TextField
              size="small"
              fullWidth
              name="title"
            ...
            >
              ...
              <Grid item xs={8}>
                ...
                >
                  ...
                  <option value="lab-faculty">LAC-Faculty</option>
